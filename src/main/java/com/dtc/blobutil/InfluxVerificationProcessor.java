...
public class InfluxVerificationProcessor {
    ...
    private static void printUsage() {
        ...
        System.out.println("  java -cp blob-util-1.0.0.jar com.dtc.blobutil.InfluxVerificationProcessor [options] [config-file]");
        System.out.println();
        ...
        System.out.println("  java -cp blob-util-1.0.0.jar com.dtc.blobutil.InfluxVerificationProcessor");
        System.out.println("  java -cp blob-util-1.0.0.jar com.dtc.blobutil.InfluxVerificationProcessor my-config.conf");
        System.out.println("  java -cp blob-util-1.0.0.jar com.dtc.blobutil.InfluxVerificationProcessor -c /path/to/config.conf");
        System.out.println();
